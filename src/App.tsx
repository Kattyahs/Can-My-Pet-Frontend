...
import HeroSection from "./layouts/index/HeroSection";
import Footer from "./components/Footer";
import { BrowserRouter as Router, Routes, Route } from "react-router-dom";
import AnimalSelection from "./layouts/animalGallery/AnimalSelection";
import AnimalSearch from "./layouts/animalDetail/AnimalSearch";
